...
DeFi can initiate legally recognized ownership transfers in centralized vehicle registries. CeFi cannot initiate or modify a KEY transaction. The bridge is one-directional by design.
