...
Core components:
- ERC-token primitive representing a digital ownership right.
...
- Composable with any distribution platform
...
- [Whitepaper](https://github.com/pablo-chacon/cut-tooling/blob/main/docs/WHITEPAPER.md)
- [Protocol Repository](https://github.com/pablo-chacon/cut-protocol) *(opens at deployment)*
- [CUT Tooling](https://github.com/pablo-chacon/cut-tooling/tree/main) *(opens at deployment)*